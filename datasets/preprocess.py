...
def load_objaverse_data(shape=(64, 64), mean=[0.5, 0.5, 0.5], std=[0.5, 0.5, 0.5], fix_choices=(0, 1), percent_objects=0.001):
    ...
    with ThreadPoolExecutor() as executor:
        futures = {
            ...
            for image_set_path in ["0d2872e2a3474ec899c4fdd009701dca", "0d87376dea3240c8a17f0e7b2275ee80", "1b443cc3c7a4408dbc899fe7334aee2d"]
            # for image_set_path in ["0d87376dea3240c8a17f0e7b2275ee80", "0d87376dea3240c8a17f0e7b2275ee80", "0d87376dea3240c8a17f0e7b2275ee80", "0d87376dea3240c8a17f0e7b2275ee80", "0d87376dea3240c8a17f0e7b2275ee80"]
            # for image_set_path in ["0d87376dea3240c8a17f0e7b2275ee80", "0d87376dea3240c8a17f0e7b2275ee80"]
        }
